...
import static com.servlet.carpeta.getString;
import static com.servlet.carpeta.webClient;
...
public class archivo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         String user=request.getParameter("txtusuer");
            ...
            try {
                ...
                .add("user",user)
                .build();
        String r = getString("subirArchivo", formBody); 
        System.out.println(r + "---");
                if (r.equals("valido")) {
                    //response.sendRedirect("inicio.jsp");
                    out.println("archivo subido!");
                    File ar=new File("C:\\Users\\elizabeth\\Desktop\\perrito"+archivo);
                    ar.createNewFile();
                  ...
                  out.println("Error: "+e.getMessage()+"cagada");
            }
        }
    }
