...
import static com.servlet.archivo.getString;
import static com.servlet.archivo.webClient;
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         String key=request.getParameter("txtkey");
            ...
            try {
                ...
                .build();
        String r = getString("descargarArchivo", formBody); 
        System.out.println(r + "---");
                if (r.equals("valido")) {
                    //response.sendRedirect("inicio.jsp");
                    out.println("archivo descargado!");
