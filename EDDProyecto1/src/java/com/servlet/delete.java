...
import static com.servlet.subirB.getString;
import static com.servlet.subirB.webClient;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         String carpeta=request.getParameter("txtcarpeta");
            ...
            try {
                ...
                .add("carpeta", carpeta)
                .build();
        String r = getString("deleteAr", formBody); 
        ...
        System.out.println(r + "---");
                if (r.equals("invalido")) {
                    ...
                    File directorio = new File("C:\\Users\\elizabeth\\Desktop\\perrito"+ingresar.carpetaUser+"\\"+carpeta+"\\"+r); 
                   directorio.delete();
