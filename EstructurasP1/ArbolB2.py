from NodoArbolB2 import Pagina
from NodoArbolB2 import Clave
from NodoArbolB2 import contenedor
...
class ArbolB2():
	...
	def graficar(self):
		...
		dot.format = 'png'
		dot.render("C:/Users/elizabeth/Desktop/Nueva carpeta (3)/EstructurasP1/ArbolB2")
	...
	def graficarC(self):
		...
		dot.format = 'png'
		dot.render("C:/Users/elizabeth/Desktop/Nueva carpeta (3)/EstructurasP1/ArbolBLuis2")
